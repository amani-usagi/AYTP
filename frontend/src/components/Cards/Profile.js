...
export default function Profile() {
	...
	<div className="relative flex flex-col min-w-0 break-words bg-gray-50 w-full mb-6 shadow-xl rounded-lg mt-16">
		<div className="flex justify-center -mt-16">
			<img src={require("../../assets/img/bprofile.svg").default} className="rounded-full border-solid border-white border-2 -mt-3 w-5/12" alt="..."/>		
		</div>
		<div className="text-center px-3 pb-6 pt-2">
			<h3 className="text-black text-sm bold font-sans">John Doe</h3>
