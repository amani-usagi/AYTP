            ...
            <form>
                ...
                <div className="flex flex-wrap">
                    <div className="w-full lg:w-12/12 px-4">
                        ...
                        <textarea type="text" className="border-0 px-3 py-3 placeholder-gray-300 text-gray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" rows="5"></textarea>
                        </div>
                    </div>
                </div>
            </form>
