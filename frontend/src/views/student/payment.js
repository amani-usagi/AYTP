...
export default function Pricing() {
    return(
        <>
        <div className="relative py-10 -mt-32 block max-w-5xl mx-auto h-500-px" >
            <div className="text-center my-10">
                <h1 className="font-bold text-3xl text-white mb-2">Select a plan </h1>
            </div>
            <div className="flex flex-col md:flex-row px-2 md:px-0">
                ...
                <div className="w-full md:w-1/3 text-white bg-blue-500 rounded-lg shadow hover:shadow-xl transition duration-100 ease-in-out p-6 md:mr-6 mb-10 md:mb-0">
                    ...
                    <button className="w-full text-blue-500 bg-white rounded hover:bg-gray-100 hover:shadow-xl transition duration-150 ease-in-out py-2 mt-4">Choose Plan</button>
                </div>
